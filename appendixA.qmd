...
This appendix is a refresher on how to read and interpret original research articles. It is especially relevant for Lab01 (finding and describing a genome analysis paper) and for later labs and projects where you will evaluate genomics studies in the context of the three perspectives from Chapter 1 and the ethical themes introduced there [@pevsner2015; @hotaling2021; @marks2021]. It largely follows the CREATE approach for introducing primary literature to undergraduates [@hoskins_crete_2011].

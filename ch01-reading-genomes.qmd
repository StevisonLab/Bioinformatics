...
![Milestones in genomics](images/Fig_1_1_genomics_timeline.png){#fig-genomics-timeline width="80%"}
...
![Core Concepts](images/Figure 1.2 Core Concepts.png){#fig-concepts width="75%"}
...
![Bioinformatics Bottleneck](images/Figure 1.3 Bioinformatic Bottleneck.png){#fig-bottleneck}
...
![Equity](images/Figure_1.4_Equity.jpeg){#fig-equity width="50%"}

...
The ultimate goal of many genomics studies is to develop integrated models that connect genome sequence to molecular phenotypes and organismal traits [@gligorijevic_methods_2015]. Multi-omic approaches combine data from different molecular layers---genome, transcriptome, epigenome, proteome, metabolome---to build comprehensive views of biological systems [@athieniti_guide_2023]. Integration of these diverse data types presents both technical and conceptual challenges but promises to reveal emergent properties not apparent from any single data type.

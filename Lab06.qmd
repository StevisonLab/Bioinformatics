...
![Simple Model](images/SimpleModel.png){#fig-simple width="75%" fig-alt="Screenshot of the excel worksheet for the lab with labels for each section in yellow pop out boxes."}
...
![Full Model](images/FullModel.jpg){#fig-full-hmm width="75%" fig-alt="Screenshot of excel workbook for the full hmm model."}

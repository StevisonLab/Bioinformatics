...
![Contrasting cluttered and organized lab benches; how does organization make you feel?](images/Figure_7-1_Organization.png){#fig-organization width="50%" fig-alt="Three photographs of clean and messy lab environments."}
...
![Continuum of methods detail from brief main-text description, to more detailed supplement, to most detailed external documentation (e.g., GitHub).](images/Figure_7-3_Detail_Strategies.jpg){#fig-detail width="75%" fig-alt="Grey box indicating reproducibility of a study based on methods section in main text and the supplement with an additional blue box outside for external documentation such as GitHub."}
